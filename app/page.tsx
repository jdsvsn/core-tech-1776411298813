...
const basePath = '/core-tech-1776411298813';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting', d: 'Our hosting services provide fast, reliable, and secure solutions for businesses looking to establish a strong online presence, with scalable plans to accommodate growing needs. Our team ensures seamless migration and 24/7 support to minimize downtime and maximize uptime.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Dev', d: 'Our web development services cater to businesses seeking custom, user-friendly, and responsive websites that reflect their brand identity and values. We utilize the latest technologies and trends to create engaging online experiences that drive conversions and revenue.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'App Dev', d: 'Our app development services enable businesses to expand their reach and engagement through mobile applications that are both functional and intuitive. We design and develop apps that meet specific business objectives, from e-commerce and productivity to entertainment and education.', i: 'https://images.pexels.com/photos/20694602/pexels-photo-20694602.png?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain', d: 'Our domain registration services provide a straightforward and efficient way for businesses to secure their online identity, with a wide range of top-level domains and competitive pricing. We also offer domain management and transfer services for existing domains.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Inquiries', d: 'Our inquiries service is designed to provide businesses with a dedicated point of contact for all their technology-related questions and concerns. Our team of experts is always available to offer guidance, support, and advice on how to leverage technology to achieve business goals.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we specialize in providing cutting-edge technology solutions to empower businesses in Kuching and beyond. With a strong focus on customer satisfaction and innovation, we strive to deliver high-quality services that exceed our clients\' expectations. Our team of experts is dedicated to helping businesses thrive in the digital landscape.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading technology solutions provider in Kuching, renowned for our exceptional service and innovative approach.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver tailored technology solutions that meet the unique needs of our clients, while fostering long-term partnerships and driving business growth through innovation and customer-centricity.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">We prioritize our customers\' needs above all else, ensuring that every interaction and solution is designed to meet their unique requirements and exceed their expectations.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">We embrace innovation as the driving force behind our business, continuously seeking new and better ways to deliver technology solutions that stay ahead of the curve and address the evolving needs of our clients.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/1181405/pexels-photo-1181405.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
